...
5. **Skills** — categorized technologies and tools.
6. **Projects** — selected real-world work with live demos and repositories.
7. **Journey** — development and learning timeline.
8. **Certifications** — completed courses and workshops, with a swipeable certificate slider.
9. **Toolbox** — everyday tools used to design, develop and ship projects.
10. **CTA** — a focused call-to-action bridging into contact.
11. **Contact** — social links and collaboration/contact interface.
12. **Footer** — navigation, brand statement and supporting links.
