...
A modern productivity workspace designed to organize tasks, manage goals, track habits, plan daily activities, monitor productivity, and bring intelligent tools into one focused system.

**Technology:** HTML5 · CSS3 · JavaScript · PWA

**Live Demo:** https://life-flow-ai-app.vercel.app
...
A financial management interface designed to help users understand and organize their finances through dashboards, transactions, budgets, savings, spending insights, and financial analytics.

**Technology:** HTML5 · CSS3 · JavaScript

**Live Demo:** https://krixora.github.io/finpulse-os/
**Repository / GitHub:** https://github.com/KRIXORA
...
**Professional Course Discovery Platform**

A focused course discovery platform designed to help users explore professional learning opportunities through a simple search and filtering experience.

**Technology:** HTML5 · CSS3 · JavaScript

**Live Demo:** https://rad-dolphin-affc57.netlify.app/
