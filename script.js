...
(() => {
    ...
    const skillsData = {
        ...
        tools: [
            ...
            },
            {
                name: "GitHub",
                icon: "github",
                description: "Repository hosting and deploying projects under KRIXORA, his personal brand.",
                level: "Deployment"
            },
            {
                name: "Vercel",
    ...
    const projectsData = {
        flowora: {
            ...
            description:
                "Productivity & Life Planner. A calm workspace for tasks, habits, goals, focus sessions, and weekly review — offline-first, installable as a PWA, with an AI coach to keep momentum.",
            ...
            caseStudy: {
                ...
                approach:
                    "Built entirely from my phone in Spck Editor, one module at a time — tasks first, then habits, then focus — testing each piece on real days before moving to the next. When architecture got tricky, I reasoned through structure instead of patching symptoms.",
                learnings:
                    "PWA fundamentals, offline-first state, and multi-module structure without a framework clicked here. Restraint mattered too — shipping a focused system beat overbuilding an unfinished one."
            }
        },
        ...
        cashora: {
            ...
            label: "Featured Project",
            description:
                "Personal Finance Dashboard. Track income, spending, budgets, and goals in one calm interface. Private by design — your data lives in your own backend. Installable PWA with net worth tracking.",
            ...
            caseStudy: {
                ...
                approach:
                    "Sketched the dashboard first, then built budgets and goals before net worth — keeping data ownership private and the UI calm so it stays usable day to day.",
                learnings:
                    "Separating the data layer from the UI early saved rework. Building finance tools also forced clearer models for transactions, budgets, and long-term tracking."
            }
        },
        ...
        coursora: {
            ...
            label: "Featured Project",
            description:
                "Course Discovery Platform. Discover free and paid courses from Udemy, Coursera, edX, and more — 125+ courses in one place, as an installable PWA.",
            ...
            caseStudy: {
                problem:
                    "Finding credible free and paid courses meant jumping between cluttered listing sites. I wanted one fast, no-noise place to explore options.",
                approach:
                    "Kept scope tight — search, filters, and a clean catalog instead of a full LMS — and shipped it as an installable PWA for quick access.",
                learnings:
                    "A focused product with clear filters beats a bloated directory. Practice in responsive UI and PWA install flow paid off in polish."
            }
        }
    };
